...
<html>
    ...
    <body>
        ...
        <div id="edit-estabelecimento" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.estabelecimento}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.estabelecimento}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.estabelecimento}" method="PUT">
                <g:hiddenField name="version" value="${this.estabelecimento?.version}" />
                <fieldset class="form">
                    <f:all bean="estabelecimento"/>
                </fieldset>
